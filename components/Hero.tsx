      ...
      <div className="relative z-10 p-6">
        ...
        <div className="flex justify-center mb-8">
          <div className="relative">
            {/* Outer glow effect */}
            <div className="absolute -inset-8 bg-gradient-to-r from-[#E63946]/20 via-[#457B9D]/20 to-[#E63946]/20 rounded-full blur-2xl animate-pulse"></div>
            
            {/* Main logo container */}
            <div className="relative">
              {/* Rotating ring */}
              <div className="absolute inset-0 rounded-full border-4 border-transparent bg-gradient-to-r from-[#E63946] via-[#457B9D] to-[#E63946] animate-spin" style={{animationDuration: '8s', clipPath: 'inset(0 0 0 0 round 50%)'}}></div>
              ...
              <div className="relative bg-gradient-to-br from-white via-gray-50 to-white p-8 rounded-full shadow-2xl m-1">
                ...
                {/* Accent dots */}
                <div className="absolute top-4 right-4 w-3 h-3 bg-[#E63946] rounded-full shadow-lg"></div>
                <div className="absolute bottom-4 left-4 w-3 h-3 bg-[#457B9D] rounded-full shadow-lg"></div>
              </div>
            </div>
          </div>
        </div>
